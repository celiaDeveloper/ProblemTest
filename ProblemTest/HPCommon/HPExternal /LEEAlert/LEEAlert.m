...
//上传图片
- (LEEConfigToStringAndBlock)LeeCancelPictureAction{
    ...
    return ^(NSString *title , void(^block)()){
        ...
        return weakSelf.LeeAddAction(^(LEEAction *action) {
            ...
            action.title = title;
            action.font = [UIFont systemFontOfSize:22];
            action.titleColor = [UIColor hex:@"424242"];
...
- (LEEConfigToStringAndBlock)LeePictureAction{
    ...
    return ^(NSString *title , void(^block)()){
        ...
        return weakSelf.LeeAddAction(^(LEEAction *action) {
            ...
            action.title = title;
            action.font = [UIFont systemFontOfSize:22];
            action.titleColor = [UIColor hex:@"121212"];
