...
/**图片 设置 -> 格式: .LeePictureAction(@"name" , ^{ //code.. })*/
@property (nonatomic , copy , readonly ) LEEConfigToStringAndBlock LeeCancelPictureAction;

/**图片 设置 取消动作 -> 格式: .LeePictureAction(@"name" , ^{ //code.. })*/
@property (nonatomic , copy , readonly ) LEEConfigToStringAndBlock LeePictureAction;
