...
- (void)setPlaceholdertext:(NSString *)Placeholdertext {
     ...
     CGSize titleSize = [Placeholdertext boundingRectWithSize:CGSizeMake(_textViewPlaceHolderLanel.frame.size.width, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:20]} context:nil].size;
